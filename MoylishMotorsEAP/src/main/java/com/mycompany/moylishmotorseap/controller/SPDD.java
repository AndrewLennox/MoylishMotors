 ...
 * @author Andrew
 */
@WebServlet(name = "SPDD", urlPatterns = {"/SPDD"})
public class SPDD extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String split = a.getName();
            split.trim();

            if (a == null) {
                address = "/Unknown.jsp";
            } else {
                address = "/SpDrillDown.jsp";
                //System.out.println(split);
                               request.setAttribute("split", split);
            }

            request.setAttribute("anAccount", a);
